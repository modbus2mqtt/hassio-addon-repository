...
exports.editableConverters = exports.MessageCategories = exports.MessageTypes = void 0;
...
})(MessageCategories || (exports.MessageCategories = MessageCategories = {}));
exports.editableConverters = ['binary_sensor', 'number', 'text', 'select', 'button'];
function validateTranslation(spec, language, msgs) {
...
function getUom(spec, entityId) {
    ...
    var entUom = spec.entities.find(function (e) {
        return e.variableConfiguration &&
            e.variableConfiguration.targetParameter == types_1.VariableTargetParameters.entityUom &&
